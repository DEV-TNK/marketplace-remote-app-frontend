              ...
              <div className="mb-3 mb-lg-0">
                <div className="">
                  <div className=" d-sm-flex justify-content-between">
                    <h3 className="mb-0">Employee of Records</h3>
                    <Link
                      className="btn btn-primary "
                      to="/jobs/employee-of-records"
                    >
                      Create Employee of records
                    </Link>
                  </div>
                  <p className="mb-0">
                    Manage your employee of records and its update like live,
                    draft, and insights.
                  </p>
                  <Link to="/employee-of-records">
                    Read more about meaning of employee of records
                  </Link>
                </div>
              </div>
            </Card.Header>
