...
import ServiceCategoryMainListViewCard from "../../../common/cards/ServiceCategoryMainListViewCard";

const ServicesCategoryListView = ({ filteredServices, setTotalFilteredServices }) => {
    ...
    Array.isArray(services) && services.length > 0
      ? services
          ...
          .map((item, index) => {
            ...
            return (
              <Col md={12} key={key}>
                <ServiceCategoryMainListViewCard
                  key={index}
                  item={item}
                  viewby="list"
                />
...
export default ServicesCategoryListView;
