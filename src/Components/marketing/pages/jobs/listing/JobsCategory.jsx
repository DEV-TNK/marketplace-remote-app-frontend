...
import JobSearchBox from "../../../common/jobs/JobSearchBox";
...
import JobsCategoryListView from "./JobsCategoryListView";
import JobsCategoryGridView from "./JobsCatergoryGridVIew";
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://marketplacebackendas-test.azurewebsites.net/api/v1/jobs-by-department?department=${category}`
      );
        ...
        <Container>
          <Row>
            <Col lg={8} md={10} xs={12}>
              <h1>Browse All Available Jobs under {category}</h1>
            </Col>
          </Row>
        </Container>
      </section>
