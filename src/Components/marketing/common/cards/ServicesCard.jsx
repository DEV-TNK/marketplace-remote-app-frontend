...
const ServicesListingCard = (props) => {
  const { item } = props;
            ...
            <div className="w-100 ms-lg-4">
              <div className="d-flex justify-content-between mt-1">
                <div>
                  ...
                  <span className="mb-1">Service as {item.serviceName}</span>
                </div>
              </div>
              <div>
                <div className="mt-4">
                  <Row className="g-2">
                    ...
                    <Col md={6} xs={12}>
                      <div>
                        ...
                        <span className="ms-1">{item.department}</span>
                      </div>
                    </Col>
                    <Col md={6} xs={12}>
                      <div>
