  ...
  return (
    <div>
      ...
      <div className="container mt-5">
        ...
        <p>
          These terms and conditions apply when registering on GetFundedAfrica’s
          Remsana.
        </p>
        ...
        <ol>
          <li>
            ...
            <p>Welcome to GFA Technologies (“GFA”, “we”, “our”, “us”)!</p>
            <p>
              These Terms of Service (“Terms”, “Terms of Service”) govern your
              use of our remsana website (together or individually “Service”)
              operated by GetFundedAfrica Media Ltd.
            </p>
            <p>
            ...
            <p>
              ...
              info@gfa-tech.com so we can try to find a solution. These Terms
          ...
          <li>
            ...
            <p>
              ...
              cancel it or GetFundedAfrica cancels it. You may cancel your
              Subscription renewal either through your online account management
              page or by contacting our support team via email
              info@gfa-tech.com.
            </p>
            <p>
              A valid payment method is required to process the payment for your
              subscription. You shall provideGetFundedAfrica with accurate and
              ...
              information, you automatically authorize GetFundedAfrica to charge
              all Subscription fees incurred through your account to any such
              payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason,
              GetFundedAfrica reserves the right to terminate your access to the
          ...
          <li>
            ...
            <p>
              GetFundedAfrica, in its sole discretion and at any time, may
            ...
            <p>
              GetFundedAfrica will provide you with a reasonable prior notice of
          ...
          <li>
            ...
            <p>We do not issue refunds for paid subscriptions.</p>
          </li>
          <li>
            ...
            <p>
              GetFundedAfrica has the right but not the obligation to monitor
              and edit all Content provided by users.
            </p>
            <p>
              In addition, Content found on or through this Service are the
              property of GetFundedAfrica or used with permission. You may not
          ...
          <li>
            ...
            <p>
              0.4. To impersonate or attempt to impersonate GetFundedAfrica, its
            ...
            <p>
              ...
              us, may harm or offend GetFundedAfrica or users of Service or
            ...
            <p>
              0.8. Take any action that may damage or falsify GetFundedAfrica’s
              rating.
            </p>
            <p>
          ...
          <li>
            <strong>No Use By Children</strong>
            <p>
              Service is intended only for access and use by individuals at
              least thirtteen (13) years old. By accessing or using Service, you
              warrant and represent that you are at least thirteen (13) years of
              ...
              Terms. If you are not at least thirteen (13) years old, you are
          ...
          <li>
            ...
            <p>
              ...
              exclusive property of GetFundedAfrica and its licensors. Service
          ...
          <li>
            ...
            <p>
              ...
              via email to info@gfa-tech.com, with the subject line: “Copyright
              Infringement” and include in your claim a detailed description of
              the alleged Infringement as detailed below.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              You may submit a notification by providing our Copyright Agent
            ...
            <p>
              You can contact our Copyright Agent via email at info@gfa-tech.com
            </p>
          </li>
          <li>
            <strong>Error Reporting and Feedback</strong>
            <p>
              You may provide us either directly at info@gfa-tech.com or via
              ...
              interest in or to the Feedback; (ii) GetFundedAfrica may have
              ...
              you or any third party; and (iv) GetFundedAfrica is not under any
              ...
              possible due to applicable mandatory laws, you grant
              GetFundedAfrica and its affiliates an exclusive, transferable,
          ...
          <li>
            ...
            <p>
              ...
              that are not owned or controlled by GetFundedAfrica.
            </p>
            <p>
              GetFundedAfrica has no control over, and assumes no responsibility
              for the content, privacy policies, or practices of any third party
              web sites or services. We do not warrant the offerings of any of
              these entities/individuals or their websites.
            </p>
            <p>
              You acknowledge and agree that GetfundedAfrica shall not be
          ...
          <li>
            ...
            <p>
              These services are provided by GetFundedAfrica on an “as is” and
              “as available” basis. GetFundedAfrica makes no representations or
            ...
            <p>
              Neither GetFundedAfrica nor any person associated with
              GetFundedAfrica makes any warranty or representation with respect
              to the completeness, security, reliability, quality, accuracy, or
              availability of the services.
            </p>
            <p>
              Without limiting the foregoing, neither GetFundedAfrica nor anyone
              associated with GetFundedAfrica represents or warrants that the
            ...
            <p>
              GetFundedAfrica hereby disclaims all warranties of any kind,
          ...
          <li>
            ...
            <p>
              ...
              regulations, even if the academy has been previously advised of
              the possibility of such damage. Except as prohibited by law, if
              there is liability found on the part of the academy, it will be
          ...
          <li>
            ...
            <p>
              No waiver by GetFundedAfrica of any term or condition set forth in
              ...
              failure of GetFundedAfrica to assert a right or provision under
          ...
          <li>
            ...
            <p>
              ...
              support by email: info@gfa-tech.com
            </p>
          </li>
        </ol>
      </div>
